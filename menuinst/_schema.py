...
class Platforms(BaseModel):
    ...
    linux: Optional[Linux] = Field(
        description="Options for Linux. See :class:`Linux` model for details."
    )
    osx: Optional[MacOS] = Field(
        description="Options for macOS. See :class:`MacOS` model for details."
    )
    win: Optional[Windows] = Field(
        description="Options for Windows. See :class:`Windows` model for details."
    )
